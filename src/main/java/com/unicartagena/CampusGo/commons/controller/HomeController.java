package com.unicartagena.CampusGo.commons.controller;
            ...
            <body class="bg-gray-100 flex items-center justify-center h-screen">
                ...
                <div class="max-w-3xl mx-auto bg-white p-8 shadow-lg rounded-lg text-center">
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <a href="http://localhost:8080/swagger-ui/index.html" target="_blank" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded block mx-auto">📜 API Docs (Swagger)</a>
                    </div>
                </div>
